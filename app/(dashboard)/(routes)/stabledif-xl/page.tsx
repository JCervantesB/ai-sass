...
const StableDiffusionXLPage = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      const response = await axios.post("/api/sdxl", values);
  ...
  return (
    <div>
      <Heading
        title="Genera imágenes con StableDiffusion XL"
        description="Genera imágenes de alta calidad a partir de descripciones en lenguaje natural con el modelo StableDiffusion XL."
        icon={ImageIcon}
...
export default StableDiffusionXLPage;
