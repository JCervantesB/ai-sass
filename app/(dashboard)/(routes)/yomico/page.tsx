...
const YomicoPage = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      const response = await axios.post("/api/yomico", values);
  ...
  return (
    <div>
      <Heading
        title="Genera imágenes Art-Tattoo estilo del artista Yomico"
        description="Genera imágenes de alta calidad a partir de descripciones en lenguaje natural con el modelo Stable Diffusion entrenado con el estilo del artista Yomico Moreno."
        icon={ImageIcon}
      ...
      <div className="px-4 lg:px-8">
        <div>
          <Form {...form}>
            ...
            >
              <Label className="col-span-12 font-semibold">Generar una imagen según tus instrucciones. <br /><span className="text-gray-500 text-sm p-2 rounded-lg font-normal">Para aprovecharlo al máximo, describe la imagen que deseas crear con el mayor detalle posible, recomendamos que especifiques que lo quieres como un tatuaje</span></Label>
              <FormField
                name="prompt"
                render={({ field }) => (
                  <FormItem className="col-span-12">
                    <FormControl className="m-0 p-0">
                      <Input
                        ...
                        disabled={isLoading}                        
                        placeholder="al estilo de TOK, una cabeza de cyborg, detalles en dorado y rojo oscuro, rosas, bordes blancos, como tatuaje en el brazo."
                        {...field}
                      />
                    </FormControl>
                  </FormItem>
