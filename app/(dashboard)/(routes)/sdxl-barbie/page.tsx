...
const SDXLBarbiePage = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      const response = await axios.post("/api/sdxl-barbie", values);
  ...
  return (
    <div>
      <Heading
        title="Genera imágenes estilo Barbie con Stable Diffusions"
        description="Genera imágenes de alta calidad a partir de descripciones en lenguaje natural con el modelo Stable Diffusion ajustado a Barbie."
        icon={ImageIcon}
