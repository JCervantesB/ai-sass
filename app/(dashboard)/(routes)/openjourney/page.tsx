...
const OpenJourneyPage = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      const response = await axios.post("/api/openjourney", values);
  ...
  return (
    <div>
      <Heading
        title="Genera imágenes con OpenJourney"
        description="Genera imágenes de alta calidad a partir de descripciones en lenguaje natural con el modelo Stable Diffusion ajustado a Midjourney v4"
        icon={ImageIcon}
...
export default OpenJourneyPage;
